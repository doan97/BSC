...
class Data(object):
    ...
    def create_inputs(self, num_time_steps, current_agent, stand_still=False):
        for i in range(0, num_time_steps):
            ...
            position_delta, position, velocity, acceleration = self.sim.update(previous_velocity, previous_position, motor_commands, current_agent, self.positions.curr_idx-1)
