...
import pyscreenshot as image_grab  # For Linux
...
class GUI:
    ...
    def __init__(self, gui_config, size, sensor_readings_dimensions):
        ...
        for x in range(gui_config.line_distance, int(canvas_width), gui_config.line_distance):
            self.canvas.create_line(x, 0, x, canvas_height, fill=gui_config.grid_fill_color)
        # horizontal lines at an interval of "line_distance" pixel
        for y in range(gui_config.line_distance, int(canvas_height), gui_config.line_distance):
            self.canvas.create_line(0, y, canvas_width, y, fill=gui_config.grid_fill_color)
        ...
        # marker
        self.marker_id = gui_config.marker_id
        self.marker_color = gui_config.marker_color
        self.marker_rad = self.draw_scale * gui_config.marker_radius
        ...
        self.agent_circle_colors = gui_config.agent_colors
        self.agent_text_colors = gui_config.agent_text_colors
        self.agent_text_size = gui_config.agent_text_size
        self.thrust_color = gui_config.thrust_color
        self.thrust_factor = gui_config.thrust_factor

        self.prediction_circle_radius_scale = gui_config.prediction_circle_radius_scale
        self.prediction_circle_color = gui_config.prediction_circle_color
        self.prediction_text_color = gui_config.prediction_text_color
        self.prediction_text_size = gui_config.prediction_text_size

        self.target_circle_radius_scale = gui_config.target_circle_radius_scale
        self.target_circle_color = gui_config.target_circle_color
        self.target_text_color = gui_config.target_text_color
        self.target_text_size = gui_config.target_text_size

        self.obstacle_circle_color = gui_config.obstacle_circle_color
        self.obstacle_text_color = gui_config.obstacle_text_color
        self.obstacle_text_size = gui_config.obstacle_text_size
