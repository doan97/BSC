...
class Inference:
    def __init__(self, inference_config, model, motor_commands_dimensions):
        self.prediction_horizon = inference_config.prediction_horizon
        self.inference_iterations = inference_config.inference_iterations
        self.step_size = inference_config.step_size

        self.position_loss_weight = inference_config.position_loss_weight
        self.sensor_readings_loss_weight = inference_config.sensor_readings_loss_weight
