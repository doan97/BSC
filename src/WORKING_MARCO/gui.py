...
class GUI(object):
    ...
    def draw(self):
        ...
        for a in self.agents:
            if a.gui_att.scv_points is not None and a.gui_att.show_scv_targets is True:
                a.gui_att.scv_ids = self.draw_scv_targets(a.gui_att.predictions, a.gui_att.scv_points,
                                                          a.gui_att.scv_ids, a.gui_att.scv_text_ids)

            a.gui_att.thrust_ids = self.draw_thrusts(a.gui_att.thrust_ids, a.gui_att.num_thrusts, a.gui_att.ball_pos,
                                                     a.gui_att.thrust_directions, a.gui_att.thrust_activity,
                                                     a.gui_att.thrust_factor, a.gui_att.thrust_color,
                                                     a.gui_att.ball_rad)
            a.gui_att.ball_id = self.draw_ball(a.gui_att.ball_id, a.gui_att.ball_pos, a.gui_att.ball_rad,
                                               a.gui_att.ball_color)
            a.gui_att.ball_real_id = self.draw_ball_real(a.gui_att.ball_real_id, a.gui_att.is_ball_real_pos_set,
                                                         a.gui_att.ball_real_pos, a.gui_att.ball_rad)
            if a.gui_att.show_target is True:
                a.gui_att.target_id = self.draw_target(a.gui_att.target_id, a.gui_att.target_pos, a.gui_att.target_rad,
            ...
            if a.gui_att.show_simulated_positions is True and a.gui_att.simulated_positions is not None:
                a.gui_att.simulated_position_ids = self.draw_simulated_positions_line(a.gui_att.simulated_position_ids,
                                                                                      a.gui_att.is_ball_real_pos_set,
                                                                                      a.gui_att.ball_real_pos,
                                                                                      a.gui_att.ball_pos,
                                                                                      a.gui_att.simulated_positions)
            a.gui_att.ball_name_id = self.draw_ball_name(a.gui_att.ball_name_id, a.id, a.gui_att.ball_pos,
                                                         a.gui_att.ball_rad, a.gui_att.ball_name_color)
            ...
            if a.gui_att.sensor_predictions is not None:
                a.gui_att.sensor_prediction_ids = self.draw_sensor_predictions(a.gui_att.sensor_predictions,
                                                                               a.gui_att.sensor_prediction_ids,
        ...
        self.panel.itemconfigure(self.prediction_error_id, text=self.prediction_error_text,
    ...
    def draw_thrusts(self, thrust_ids, num_thrusts, ball_pos, thrust_directions, thrust_activity, thrust_factor,
        ...
        for i in range(num_thrusts):
            r = gauss(0, 0.1)
            points = [
                ball_pos[0] - int((1.0 + r) * thrust_directions[i, 0] * thrust_activity[i] * thrust_factor * (
                            ball_rad * self.drawscale)),
                ball_pos[1] + int((1.0 + r) * thrust_directions[i, 1] * thrust_activity[i] * thrust_factor * (
                            ball_rad * self.drawscale)),
                ball_pos[0],
                ball_pos[1] - 5,
                ball_pos[0],
    ...
    def draw_simulated_positions_line(self, simulated_positions_ids, is_ball_real_pos_set, ball_real_pos, ball_pos,
                                      simulated_positions):
